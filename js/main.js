document.addEventListener("DOMContentLoaded", function(event){
    ...
    // })
        ...
        tHeader
        .to('.header__masking--maskLayer', { duration: 0, opacity: 1, stagger: 0.12, ease: "none" })

        .add('head', '-=0.2')
        .to('.header__masking', { duration: 0, opacity: 0, ease: "none" }, 'head')
        .to('.header__paralax', { duration: 0, opacity: 1, ease: "none" }, 'head')
        ...
        setTimeout(function() {
            $(window).scroll(function () {
              ...
              let color_cloud = document.getElementById('cloud');
              ...
              planet.style.marginLeft  = value * -0.1 + 'px';
              big_island.style.marginBottom  = value * 0.05 + 'px';
              small_island.style.marginBottom  = value * 0.01 + 'px';
              small_island_left.style.marginBottom  = value * 0.012 + 'px';
              middle_island.style.marginBottom  = value * 0.03 + 'px';
              planet2.style.marginLeft  = value * 0.15 + 'px';
              ...
              grass.style.marginTop = value * -0.06 + 'px';
              sun.style.marginTop = value * 0.35 + 'px';
